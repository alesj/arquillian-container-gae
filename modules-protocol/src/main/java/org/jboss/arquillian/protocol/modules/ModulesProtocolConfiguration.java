...
/**
 * Extend ServletProtocolConfiguration.
 *
...
public class ModulesProtocolConfiguration extends ServletProtocolConfiguration {
    ...
    public boolean isFailOnMissingModule() {
        return failOnMissingModule;
    }

    public void setFailOnMissingModule(boolean failOnMissingModule) {
        this.failOnMissingModule = failOnMissingModule;
    }
